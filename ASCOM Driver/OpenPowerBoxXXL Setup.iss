...
; Generated by Antiath on 16/11/2025 (UTC)
;
[Setup]
AppID={{d9349083-7cba-4a08-bc4c-a936acbef5b8}
AppName=ASCOM OpenPowerBoxXXL Switch Driver
AppVerName=ASCOM OpenPowerBoxXXL Switch Driver 0.2
AppVersion=0.2
...
[Files]
Source: "C:\Users\mispe\source\repos\AstroPowerBoxXXL0.2\bin\Release\ASCOM.AstroPowerBoxXXL.exe"; DestDir: "{app}"
...
Filename: "{app}\ASCOM.AstroPowerBoxXXL.exe"; Parameters: "/register"
...
; Only for .NET local-server drivers
Filename: "{app}\ASCOM.AstroPowerBoxXXL.exe"; Parameters: "/unregister"
