...
namespace ASCOM.OpenPowerBox.Switch
{
    ...
    [ProgId("ASCOM.OpenPowerBox.Switch")]
    [ServedClassName("ASCOM Switch Driver for OpenPowerBox")] // Driver description that appears in the Chooser, customise as required
