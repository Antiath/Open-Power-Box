...
namespace ASCOM.OpenPowerBoxXXL.Switch
{
    public partial class Form1 : MetroForm
    {
        ...
        private void PopulateParam()
        {
            ...
            this.name10.Text = SwitchHardware.name[10];
            this.name11.Text = SwitchHardware.name[11];
            ...
            if (SwitchHardware.numUSB > 0)
            {
                this.name12.Text = SwitchHardware.name[12];
                this.name13.Text = SwitchHardware.name[13];
                this.name14.Text = SwitchHardware.name[14];
                this.name15.Text = SwitchHardware.name[15];
                this.name16.Text = SwitchHardware.name[16];
                this.name17.Text = SwitchHardware.name[17];
                this.name18.Text = SwitchHardware.name[18];
            }
        ...
        private async Task PopulateDashboard()
        {
            if (SwitchHardware.connectedState)
            {
                ...
                //{
                    ...
                    this.Rail.Checked = Convert.ToBoolean(int.Parse(SwitchHardware.state[10].Substring(0, 1)));
                    this.Relay.Checked = Convert.ToBoolean(int.Parse(SwitchHardware.state[11].Substring(0, 1)));
                    if (SwitchHardware.numUSB == 7) { 
                    this.USB1.Checked = Convert.ToBoolean(int.Parse(SwitchHardware.state[12].Substring(0, 1)));
                    this.USB2.Checked = Convert.ToBoolean(int.Parse(SwitchHardware.state[13].Substring(0, 1)));
                    this.USB3.Checked = Convert.ToBoolean(int.Parse(SwitchHardware.state[14].Substring(0, 1)));
                    this.USB4.Checked = Convert.ToBoolean(int.Parse(SwitchHardware.state[15].Substring(0, 1)));
                    this.USB5.Checked = Convert.ToBoolean(int.Parse(SwitchHardware.state[16].Substring(0, 1)));
                    this.USB6.Checked = Convert.ToBoolean(int.Parse(SwitchHardware.state[17].Substring(0, 1)));
                    this.USB7.Checked = Convert.ToBoolean(int.Parse(SwitchHardware.state[18].Substring(0, 1)));
                }
        ...
        {
            SwitchHardware.SetSwitchValueUSB(10, Convert.ToDouble(Rail.Checked));
        }

        private void Relay_CheckedChanged(object sender, EventArgs e)
        {
            SwitchHardware.SetSwitchValueUSB(11, Convert.ToDouble(Relay.Checked));
        }
        ...
        {
            SwitchHardware.SetSwitchValueUSB(12, Convert.ToDouble(USB1.Checked));
        }

        private void USB2_CheckedChanged(object sender, EventArgs e)
        {
            SwitchHardware.SetSwitchValueUSB(13, Convert.ToDouble(USB2.Checked));
        }

        private void USB3_CheckedChanged(object sender, EventArgs e)
        {
            SwitchHardware.SetSwitchValueUSB(14, Convert.ToDouble(USB3.Checked));
        }

        private void USB4_CheckedChanged(object sender, EventArgs e)
        {
            SwitchHardware.SetSwitchValueUSB(15, Convert.ToDouble(USB4.Checked));
        }

        private void USB5_CheckedChanged(object sender, EventArgs e)
        {
            SwitchHardware.SetSwitchValueUSB(16, Convert.ToDouble(USB5.Checked));
        }

        private void USB6_CheckedChanged(object sender, EventArgs e)
        {
            SwitchHardware.SetSwitchValueUSB(17, Convert.ToDouble(USB6.Checked));
        }

        private void USB7_CheckedChanged(object sender, EventArgs e)
        {
            SwitchHardware.SetSwitchValueUSB(18, Convert.ToDouble(USB7.Checked));
        }
